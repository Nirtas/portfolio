...
import com.jerael.mesagisto.database.deleteChatMessageInDb
import com.jerael.mesagisto.database.editChatMessageInDb
...
class ChatAdapter : RecyclerView.Adapter<RecyclerView.ViewHolder>() {
    ...
    fun clearList() {
        val size = listMessagesCache.size

        if (size > 0) {
            listMessagesCache.clear()
