                    ...
                    <div style='padding-left: 15px;'>
                        ...
                        <div id='specs'>
                            <table>
                                ...
                                <tr>
                                    <td>Мощность</td>
                                    <td>".$array[$id]['power']." Вт</td>
                                <tr>
                                    <td>Объем емкости для зерен</td>
                                    <td>".$array[$id]['beanVolume']." гр</td>
                                </tr>
                                <tr>
                                    <td>Объем резервуара для воды</td>
                                    <td>".$array[$id]['waterVolume']." мл</td>
                                </tr>
                                <tr>
                                    <td>Капучинатор</td>
                                    <td>".$array[$id]['cappMaker']."</td>
                                </tr>
                                <tr>
                                    <td>Максимальное давление</td>
                                    <td>".$array[$id]['maxPress']." Бар</td>
                                </tr>
                                <tr>
                                    <td>Количество степеней помола</td>
                                    <td>".$array[$id]['numDegreesGrind']."</td>
                                </tr>
                                <tr>
                                    <td>Подогрев чашек</td>
                                    <td>".$array[$id]['cupWarmer']."</td>
                                </tr>
                                <tr>
                                    <td>Тип используемого кофе</td>
                                    <td>".$array[$id]['coffeeType']."</td>
                                </tr>
                                <tr>
                                    <td>Цвет</td>
